...
public static class Utility
{
    ...
    /// <summary>
    /// Calulates the signed angle the <see cref="Vector3"/> <paramref name="from"/> and <paramref name="to"/>
    /// in degrees using <paramref name="normal"/> as a normal.
    /// </summary>
    ...
    /// when projected on the plane described by <paramref name="normal"/>.
    /// The result is between -179 and 180 degrees.
    /// </returns>
...
public static class UtilityExtensions
{
    ...
    /// <summary>
    /// Checks if this <see cref="Rigidbody"/> is moving forwards.
    /// </summary>
